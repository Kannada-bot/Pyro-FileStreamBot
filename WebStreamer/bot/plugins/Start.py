                        ...
                        [
                            ...
                            [
                                InlineKeyboardButton("🔄 Refresh / Try Again",
                                                     url=f"https://t.me/kannadastrikers_Bot?start=KannadaWarriors_{usr_cmd}")
                            ]
                        ]
                    ),
                    parse_mode="markdown"
...
async def help_handler(bot, message):
        ...
        try:
            ...
            if user.status == "kicked":
                await bot.send_message(
                    ...
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/KannadaWarriors).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Support Group", url="https://t.me/KannadaWarriors"), InlineKeyboardButton("ಹೊಸ ಚಲನಚಿತ್ರಗಳು", url="https://t.me/KannadaWarriors")],
                [InlineKeyboardButton("Developer", url="https://t.me/NithinMovies")]
            ]
        )
    )
